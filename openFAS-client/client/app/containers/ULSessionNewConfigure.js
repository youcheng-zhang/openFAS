...
import PatientNew from './ULPatientNew';
import * as appActions from '../store/app';
import * as patientActions from '../store/ULpatients';
import * as exerciseActions from '../store/ULexercises';
...
class SessionNewConfigure extends React.Component {
  ...
  render() {
    return (
      <Modal
        key="ULSessionNewConfigureModal"
        centered={true}
...
const mapStateToProps = state => ({
  app: state.app,
  exercises: state.ULexercises.entities,
  patients: state.ULpatients.entities,
  loadingPatients: state.ULpatients.status.loading,
  loadingExercises: state.ULexercises.status.loading
});
