...
"""
# uncomment to run cells in vscode
# change the cwd to analyser folder
import os
os.chdir("C:/Users/xqsxl/Desktop/openFAS-client/analyser")
"""
import pandas as pd
...
from staticDataGenerator import get_training_data
import postures
...
module_filename = "ML/ML_static_module"
...
for post in posture_to_train:
    df, datasize = get_training_data(post)
